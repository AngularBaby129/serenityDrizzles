                ...
                <div class="kindsIntegration-content">
                    <ul class="kindsIntegration-contentList teamIntegration-contentList" >
                        ...
                        <li v-for="item in responsePointsList">
                            ...
                            <p class="listRight">{{item.Score}}<span class="icon icon-arrowLg-r" @click="gooToPointHtml(item.Name)"></span></p>
...
//                debugger;
                ...
                url = '../salespoints/importantScore.html?name='+nameNow+'&dateTime='+date + month;
...
//            var dateTime = date.format("YYYYMM");
            ...
            var url = '/sicaih5/dist/module/mine.html#/problemFeedback?type=teamImportantScore';
