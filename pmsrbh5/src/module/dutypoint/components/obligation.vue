...
//                  _self.evaluate = [];
                  ...
                  if(actionTotals==undefined||actionTotals==""||actionTotals==null){
                    ...
                    if(channelType=="WSM"){
                      ...
                      _self.responsePointsListW[1].points = actionTotals[0].salesmanSurveyPoints;
                      //承接客户商机
                      _self.responsePointsListW[2].actionFinishValue = actionTotals[0].followCustOptyCondition;
                      _self.responsePointsListW[2].actionFinishPercent = actionTotals[0].custOptyfinishPercent + '%';
                      _self.responsePointsListW[2].points = actionTotals[0].custOptyPoints;
                      //其他商机
                      _self.responsePointsListW[3].actionFinishValue = actionTotals[0].salesManOptyCondition;
                      _self.responsePointsListW[3].actionFinishPercent = actionTotals[0].salesManOptyfinishPercent + '%';
